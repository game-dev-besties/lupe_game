...
var levels = [
	# --- LEVEL 1 ---
	{
		...
		"npcs": [
			{"name": "brother1", "desire": "rice", "timer": 1, "sound": preload("res://assets/sfx/girlhum.mp3")},
	...
	# --- LEVEL 2 ---
	{
		...
		"npcs": [
			{"name": "brother1", "desire": "rice", "timer": 5, "sound": preload("res://assets/sfx/girlhum.mp3")},
			{"name": "mother1", "desire": "rice", "timer": 1.5, "sound": preload("res://assets/sfx/malegrunt.mp3")},
			{"name": "father1", "desire": "rice", "timer": 5, "sound": preload("res://assets/sfx/malegrunt.mp3")},
	...
	# --- LEVEL 4 ---
	{
		...
		"npcs": [
			{"name": "brother3", "desire": "rice", "timer": 5, "sound": preload("res://assets/sfx/girlhum.mp3")},
			{"name": "bwife2", "desire": "rice", "timer": 1.5, "sound": preload("res://assets/sfx/malegrunt.mp3")},
			{"name": "mother3", "desire": "rice", "timer": 5, "sound": preload("res://assets/sfx/malegrunt.mp3")},
